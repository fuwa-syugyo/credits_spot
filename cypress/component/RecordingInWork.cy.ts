...
describe('RecordingInWork tests', () => {
  ...
  it('Less than 100 recordings', () => {
    cy.intercept(
      'GET',
      'https://musicbrainz.org/ws/2/work/0eb34006-eac6-466c-a692-42a52741d354?inc=recording-rels+artist-credits&fmt=json',
      { fixture: 'mock_uma.json' }
    ).as('umaRequest')
    cy.mount(RecordingInWork, {
      props: { id: '0eb34006-eac6-466c-a692-42a52741d354' },
    } as OptionsParam)
    cy.wait('@umaRequest')
