...
describe('Artist have songwriter and staff tables', () => {
  it('Songwriter table', () => {
    cy.intercept(
      'GET',
...
describe('Artist have songwriter and artist tables', () => {
  it('Songwriter table', () => {
    cy.intercept(
      'GET',
...
describe('Artist have staff and artist tables', () => {
  it('Staff table', () => {
    cy.intercept(
      'GET',
...
describe('Artist have only songwriter table', () => {
  it('Songwriter table', () => {
    cy.intercept(
      'GET',
...
describe('Artist have only staff table', () => {
  it('Staff table', () => {
    cy.intercept(
      'GET',
...
describe('Artist have only artist table', () => {
  it('Artist table', () => {
    cy.intercept(
      'GET',
...
describe('Check recording of songwriter and staff results are not change by using pagination', () => {
  it('Using pagination', () => {
    cy.intercept(
      'GET',
      'https://musicbrainz.org/ws/2/artist/53bfc28e-2c48-4776-8949-1953c78dd187?inc=recording-rels+artist-rels+artist-credits+work-rels&fmt=json',
